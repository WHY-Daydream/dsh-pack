...
export const apply = (ctx: Context): (() => void) => {
  ...
  disposers.push(ctx.commands.register({
    ...
    input: { hint: '[profile] | inspect <file> | verify <file> | install <file> | sign <file> | keygen | policy <file> | evidence <sign|verify|provenance|sbom|capability|attestation> | image <import|ls|inspect|tag|rm> | run <ref>' },
    handler,
  }))
